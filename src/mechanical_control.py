...
pwm.set_pwm_freq(500) # Частота ШИМ-сигнала, равная 50Гц (20 мс) - для работы серво
...
#
    ...
    # все вперед
        ...
        FL_on_F = 4096
        FR_on_F = 3096 # переднее правое колесо вперед - значение ШИМ
        FR_off_F = 1000 # переднее правое колесо вперед - значение ШИМ
        BL_on_F = 4096
        BR_on_F = 4096
    ...
    # все назад
        ...
        y += speed
        FL_on_B = 4096 
        FR_on_B = 4096 # переднее правое колесо назад - значение ШИМ
        BL_on_B = 4096
        BR_on_B = 4096
