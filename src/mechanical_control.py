...
test_servo_center = 307 # 291 (307) - среднее (математическое) положение между крайними значениями, можно скорректировать для более точного совпадения с геометрией корпуса
test_servo_max = 497 # 514 (497) - максимальное значение сработки - превышает угол 90
