...
test_servo_min = 113 # 68 - минимальное значение сработки для синих - превышает угол 90 / для зеленых и больших - 68
test_servo_center = 293 # 291 - среднее (математическое) положение между крайними значениями, можно скорректировать для более точного совпадения с геометрией корпуса
test_servo_max = 473 # 514 - максимальное значение для синих - превышает угол 90 / для зеленых и больших - 510
