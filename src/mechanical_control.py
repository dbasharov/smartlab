...
test_servo_min = 114 # 68 - минимальное значение сработки для синих - превышает угол 90 / для зеленых - 80
test_servo_center = 295 # 291 - среднее (математическое) положение между крайними значениями, можно скорректировать для более точного совпадения с геометрией корпуса / для зеленых - 290 среднне математическое
test_servo_max = 478 # 514 - максимальное значение сработки для синих - превышает угол 90 / для зеленых - 510
