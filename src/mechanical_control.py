...
test_servo_min = 67 # 68 (117) - минимальное значение сработки - превышает угол 90
test_servo_center = 307 # 291 - среднее (математическое) положение между крайними значениями, можно скорректировать для более точного совпадения с геометрией корпуса
test_servo_max = 497 # 514 (497) - максимальное значение сработки для синих - превышает угол 90 / для зеленых - 511
