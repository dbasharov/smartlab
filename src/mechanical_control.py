...
test_servo_min = 109 # 68 - минимальное значение сработки для синих - превышает угол 90 / для зеленых и больших - 68
test_servo_center = 289 # 291 - среднее (математическое) положение между крайними значениями, можно скорректировать для более точного совпадения с геометрией корпуса / для зеленых - 290 среднне математическое
test_servo_max = 469 # 514 - максимальное значение сработки для синих - превышает угол 90 / для зеленых и больших - 510
