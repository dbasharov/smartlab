...
try:
    ...
    # while True:
        servo.setPWM(wheelLeftFrontForward, 3000, 0)
        servo.setPWM(wheelRightFrontForward, 3000, 0)
        servo.setPWM(wheelLeftRearForward, 3000, 0)
        servo.setPWM(wheelRightRearForward, 3000, 0)
        time.sleep(0.01)
