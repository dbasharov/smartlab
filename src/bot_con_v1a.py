...
while 1: #запускаем общий цикл для всего - оптимизировать?
    ...
    if flLeft:
        ...
        FL_on_B = 3096 # переднее левое крутим назад
        FR_on_F = 3096 # переднее правое крутим вперед
        BL_on_B = 3096 # заднее левое крутим назад
        BR_on_F = 3096 # заднее правое крутим вперед
...
#
    # правый танковый разворот
        ...
        x += speed
        FL_on_F = 3096 # переднее левое крутим вперед
        FR_on_B = 3096 # переднее правое крутим назад
        BL_on_F = 3096 # заднее правое крутим вперед
        BR_on_B = 3096 # заднее правое крутим назад
