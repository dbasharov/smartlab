...
#
    ...
    pwm.set_pwm(5, FL_on_F, FL_off_F) # Передний левый вперёд
    pwm.set_pwm(4, FL_on_B, FL_off_B) # Передний левый назад
    pwm.set_pwm(7, FR_on_F, FR_off_F) # Передний правый вперед
    pwm.set_pwm(6, FR_on_B, FR_off_B) # Передний правый назад

    pwm.set_pwm(9, BL_on_F, BL_off_F) # Задний левый вперед
    pwm.set_pwm(8, BL_on_B, BL_off_B) # Задний левый назад
    pwm.set_pwm(11, BR_on_F, BR_off_F)# Задний правый вперед
    pwm.set_pwm(10, BR_on_B, BR_off_B)# Задний правый назад
