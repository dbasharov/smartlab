...
while 1: #запускаем общий цикл для всего - оптимизировать?
    ...
    if flLeft:
        ...
        FL_on_B = 1496 # переднее левое крутим назад
        FR_on_F = 1496 # переднее правое крутим вперед
        BL_on_B = 1496 # заднее левое крутим назад
        BR_on_F = 1496 # заднее правое крутим вперед
...
#
    # правый танковый разворот
        ...
        x += speed
        FL_on_F = 1496 # переднее левое крутим вперед
        FR_on_B = 1496 # переднее правое крутим назад
        BL_on_F = 1496 # заднее правое крутим вперед
        BR_on_B = 1496 # заднее правое крутим назад
