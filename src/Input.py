...
def get_keyboard_values():
    """
Опросить клавиатуру и назначить переменным состояние клавиш

    """


    # словарь для присвоения состояний нажатия клавиш нашим переменным,
    # отвечающим за управление по нажатию кнопок
    keys = dict()
    keys['flagLeft'] = False
